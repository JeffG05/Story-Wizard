...
struct SlidePage: Identifiable, Equatable {
    ...
    static var samplePages: [SlidePage] = [
        ...
        SlidePage(name: "LIBRARY", description: "Here is where you store the books you have read. Click on one of the buttons to turn on a filter and click again to turn it off. Click on a book to see a preview of it. Click read to enjoy your story!", image: "Library", tag: 2),
